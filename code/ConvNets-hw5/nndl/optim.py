...
def rmsprop(w, dw, config=None):
  ...
  w = w - config['learning_rate']/(np.sqrt(config['a']) + config['epsilon']) * dw
  next_w = w
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
...
def adam(w, dw, config=None):
  ...
  v_correct = 1/(1 - np.power(config['beta1'], config['t'])) * v
  a_correct = 1/(1 - np.power(config['beta2'], config['t'])) * a
  w = w - config['learning_rate']/(np.sqrt(a_correct) + config['epsilon']) * v_correct
  next_w = w
  config['a'], config['v'] =a, v
